/*
 * gtk_tree_view_three.c
 *
 *  Created on: 15 sty 2018
...
int main(int argc, char **argv){
	...
	gtk_window_set_title(GTK_WINDOW(window), "Stare rzeczy...");
	...
	add = gtk_button_new_with_label("Dodaj");
	remove = gtk_button_new_with_label("Usuń");
	removeall = gtk_button_new_with_label("Wyczyść wszystko");
	entry = gtk_entry_new();
